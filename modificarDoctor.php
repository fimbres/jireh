...
$BD = new BaseDeDatos();
$doctor = Doctor::crear_Doctor($_GET['id'],$BD);
if(!$doctor){
    $BD->close();
    header('location: index.php');
}
...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
    ...
    $modif  = ($doctor->getUsuarioNombre() == $_POST['usuario'] ? "modificar_usuario_igual" : "modificar");
    $mensaje = Doctor::verificar_datos_formulario($_POST,$BD,$modif);
    if (!$mensaje) {
                    ...
                    <form method="POST" class="form d-flex row col-xl-8 col-md-12 justify-content-center formulario-registrar">
                        <div class="form-row row">
                            <div class="form-group col-xl-6 col-md-12 pb-4">
                                <label for="nombre_inpt_Doctor"><b>*</b>Nombre(s)</label>
                                <input 
                                    id="nombre_inpt_Doctor" 
                                    ...
                                    required 
                                    maxlength="20"
                                    <?php echo "value='{$doctor->getNombre()}'"?>
                                    >
                            </div>
                            <div class="form-group col-xl-6 col-md-12 pb-4">
                                <label for="apaterno_inpt_doctor"><b>*</b>Apellido Paterno</label>
                                <input 
                                    id="apaterno_inpt_doctor" 
                                    name="apellido_p" 
                                    type="text" 
                                    class="form-control text-capitalize
                                    ...
                                    required 
                                    maxlength="15"
                                    <?php echo "value='{$doctor->getApellido_p()}'"?>
                                    >
                            </div>
                        </div>
                        <div class="form-row row">
                            <div class="form-group col-xl-6 col-md-12 pb-4">
                                <label for="amaterno_inpt_doctor">Apellido Materno</label>
                                <input 
                                    id="amaterno_inpt_doctor" 
                                    name="apellido_m" 
                                    type="text" 
                                    class="form-control text-capitalize" 
                                    ...
                                    maxlength="15"
                                    <?php 
                                    if($doctor->getApellido_m())
                                        echo "value='{$doctor->getApellido_m()}'";
                                    ?>
                                    >
                            </div>
                            <!-- data-mask='(+00) 000-000-0000' -->
                            <div class="form-group col-xl-6 col-md-12 pb-4">
                                <label for="telefono_inpt_doctor"><b>*</b>Teléfono</label>
                                <input 
                                    id="telefono_inpt_doctor" 
                                    name="telefono" 
                                    type="tel" 
                                    class="form-control 
                                    ...
                                    required 
                                    maxlength="13"
                                    <?php echo "value='{$doctor->getTelefono()}'"?>

                                    >
                            </div>
                            <div class="form-group col-xl-6 col-md-12 pb-4">
                                <label for="correo_inpt_doctor"><b>*</b>Correo electrónico</label>
                                <input 
                                    id="correo_inpt_doctor" 
                                    name="correo" 
                                    type="email" 
                                    class="form-control 
                                    ...
                                    required 
                                    maxlength="50"
                                    <?php echo "value='{$doctor->getCorreo()}'"?>
                                    
                                    >
                            </div>
                            <div class="form-group col-xl-6 col-md-12 pb-4">
                                <label for="usuario_inpt_doctor"><b>*</b>Usuario</label>
                                <input 
                                    id="usuario_inpt_doctor" 
                                    name="usuario" 
                                    type="text" 
                                    class="form-control 
                                    ...
                                    required 
                                    maxlength="10"
                                    <?php echo "value='{$doctor->getUsuarioNombre()}'"?>
                        ...
                        <div class="form-row row justify-content-center pt-3">
                            ...
                            <a class="row btn btn-danger mx-3 col-md-3  col-5" href="gestionDoctores.php">Cancelar</a>
                        </div>
                    </form>
                </div>
            </div>
